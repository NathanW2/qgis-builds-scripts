...
set PATH=%PATH%;%QGIS%\bin;C:\Program Files (x86)\Git\bin;C:\apps\vim72\;C:\Program Files (x86)\LLVM\bin;C:\Users\Nathan\AppData\Roaming\npm;C:\Program Files (x86)\nodejs\
set PATH=%PATH%;F:\dev
set PYTHONPATH=%QGIS%\python;%PYTHONPATH%

start "Vim aware of QGIS" /B "F:\apps\emacs\bin\runemacs.exe" --debug-init